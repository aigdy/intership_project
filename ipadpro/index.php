...
<body>
	...
	<div id="Container">
		...
		<div id="second_box">
			...
			<br>
			<div id="text_second_box">
			<p>it’s an uncompromising vision of personal computing for the modern world.
			 ...
			 And whether you choose the 12.9-inch model or the new 9.7-inch model,iPad Pro is more capable,
			 versatile, and portable than anything that’s come before. In a word, super.
			 <br><br><!-- <br><br> -->
			 </div>
			 ...
			 <div class="product_choice">
			 	<p>
			 		<div class="head_text_product">9.7-inch iPad Pro</div>
					Incredibly portable, with an unprecedented combination of versatility and performance.<br>
					screen resolution : 2048×1536<br>
				</p>
					<div class="color_text2">Color :</div><!-- color_text -->
